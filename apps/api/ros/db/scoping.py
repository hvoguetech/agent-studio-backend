...
# Request-scoped tenant id, read by the Postgres RLS GUC listener (see ros.db.base) so the
...
_current_tenant: ContextVar[str | None] = ContextVar("ros_current_tenant", default=None)
