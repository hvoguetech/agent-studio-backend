...
register(NodeSpec(
    type="webhook_in", schema_id="ros/nodes/trigger_webhook",
...
register(NodeSpec(
    type="schedule", schema_id="ros/nodes/trigger_schedule",
    input_ports=[], output_ports=_out, factory=_passthrough_factory,
...
register(NodeSpec(
    type="email_in", schema_id="ros/nodes/trigger_email",
    input_ports=[], output_ports=_out, factory=_passthrough_factory,
...
register(NodeSpec(
    type="app_event", schema_id="ros/nodes/trigger_app_event",
    input_ports=[], output_ports=_out, factory=_passthrough_factory,
