...
from ros.engine.expressions import ExpressionError, eval_expression, eval_truthy
from ros.engine.registry import NodeSpec, Port, register

log = logging.getLogger("ros.flow")
...
register(
    NodeSpec(
        ...
        schema_id="ros/nodes/parallel_fanout",
...
register(
    NodeSpec(
        type="subworkflow",
        schema_id="ros/nodes/subworkflow",
        input_ports=[Port(id="in", io_type="any", direction="in")],
        output_ports=[Port(id="out", io_type="any", direction="out")],
