...
from ros.models import Dataset, EvalResult, EvalRun
from ros.services.dispatch import dispatch_message
from ros.services.quota import QuotaExceeded, check_run_quota
from ros.services.runs import RunService

log = logging.getLogger("ros.evals")
    ...
    async def _assertion(a: dict, answer: str, item_expected: str, *, judge_model, embedder, inp: str) -> dict:
        ...
        if typ in ("contains", "exact", "regex"):
            ...
            if embedder is None:
                ...
                from ros.knowledge.embeddings import cosine
