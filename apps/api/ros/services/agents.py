"""Agent preset CRUD. Config validates against the agent node schema (ros/nodes/agent)."""
...
class AgentService:
    ...
    def validate(config: dict) -> list[dict]:
        return validate_against_id(config, "ros/nodes/agent")
