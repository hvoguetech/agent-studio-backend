...
Stored in a dim-keyed collection (`ros_cache_<dim>`) with the answer + timestamp in
...
# Cache defaults (env-overridable: ROS_SEMANTIC_CACHE_THRESHOLD / _TTL_SECONDS). Threshold is
...
class SemanticCacheService:
    @staticmethod
    def _store(embedder):
        return make_store(collection=f"ros_cache_{embedder.dim}")
