...
from ros.models import Tenant, User
from ros.models.entities import UserSecurity
...
class AuthService:
    ...
    async def delete_workspace(session, *, tenant_id: str, checkpointer=None) -> None:
        ...
        from ros.models import AuditLog, Project
        from ros.models.entities import ApiKey, ProjectMember
