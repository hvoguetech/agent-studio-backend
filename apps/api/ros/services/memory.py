...
dim-keyed vector collection (`ros_mem_<dim>`); scoped per project (+ optional `scope`
...
class MemoryService:
    @staticmethod
    def _store(embedder):
        return make_store(collection=f"ros_mem_{embedder.dim}")
