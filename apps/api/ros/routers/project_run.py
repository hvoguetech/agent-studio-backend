...
travel out-of-band in the `X-ROS-Context` header -> `{{ctx.*}}` in tools, never in the body.
...
from ros.schemas.dto import ProjectRunIn
...
async def project_run(
    ...
    from ros.services.budget import BudgetExceeded, ModelNotAllowed
