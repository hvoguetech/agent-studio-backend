...
async def embed_stream(
    ...
    async def gen():
        ...
        # run_context is NOT taken from the anonymous browser: X-ROS-Context is a trusted
        # server-side caller channel, so honoring it here would let an end user ros {{ctx.*}}
