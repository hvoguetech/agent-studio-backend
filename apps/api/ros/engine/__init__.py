"""ROS execution engine: JSON workflow definitions -> compiled LangGraph graphs.
...
from ros.engine.registry import NODE_REGISTRY, NodeSpec, Port, io_compatible, register
