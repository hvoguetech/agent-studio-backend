...
from ros.knowledge.embeddings import _est_tokens, resolve_embedder
from ros.tracing.tracer import ROSTracer, embedding_span
...
async def test_embed_call_records_embedding_span():
    tr = ROSTracer()  # __init__ binds this as the active tracer for this async context
