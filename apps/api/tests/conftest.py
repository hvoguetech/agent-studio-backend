...
a throwaway temp dir *before* any `ros` module imports (the engine, settings, secret
...
_TMP = Path(tempfile.mkdtemp(prefix="ros_tests_"))
os.environ.setdefault("ROS_DATABASE_URL", f"sqlite+aiosqlite:///{(_TMP / 'test.db').as_posix()}")
os.environ.setdefault("ROS_CHROMA_PATH", (_TMP / "chroma").as_posix())
os.environ.setdefault("ROS_CHECKPOINT_DB", "memory")
os.environ.setdefault("ROS_SECRET_KEY_FILE", (_TMP / "master.key").as_posix())
os.environ.setdefault("ROS_SEED_DEMO", "false")
...
os.environ.setdefault("ROS_EGRESS_BLOCK_PRIVATE", "false")
...
os.environ.setdefault("ROS_AUTH_REQUIRED", "false")

import pytest  # noqa: E402

from ros.db.base import init_db  # noqa: E402
