...
# settings.tool_vars (FORGE_TOOL_VARS) - a per-environment endpoint value - so a template that
...
async def execute_rest(
    ...
    *,
    ...
    # values from FORGE_TOOL_VARS). env is fail-loud (_STRICT_NS); ctx is lenient.
